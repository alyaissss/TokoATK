...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .login-box { width: 100%; max-width: 380px; padding: 2.5rem 2rem; background: #fcf5eb; border-radius: 12px; border: 1px solid #d3bca4; box-shadow: 0 4px 6px -1px rgba(92,64,51,0.12); color: #403127; }
